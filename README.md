...
> Visual guides, lab reports, and research on electronics —
> created by two students from Baku, verified by Physics Teacher Telman Askeraliyev.
...
| | Najabat Sophiyeva | Nijat Mazanli |
|---|---|---|
| **Role** | Co-Author · iOS Developer | Co-Author · Engineer |
| **Location** | Baku, Azerbaijan | Baku, Azerbaijan |
| **Skills** | iOS / Swift · SwiftUI · Physics · Electronics | Electronics · Circuit Theory · Physics · Education |
